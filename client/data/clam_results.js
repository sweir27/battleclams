export default [
  ...
  },
  {
    ...
    description:
      "The giant clam (Tridacna gigas), known as pā’ua in Cook Islands Māori, is a clam that is the largest living bivalve mollusk. Giant clams are beautiful, curious, and weird. Highly independent and somewhat fearful, when backed into a corner they can be ferocious.",
    attributes: {
      fun: 2,
      honor: 2,
      intelligence: -7,
  ...
  },
  {
    ...
    description:
      "The razor shell, Ensis magnus, also called razor clam, razor fish, or spoot (colloquially), is a bivalve of the family Pharidae. It is found on sandy beaches in Northern Europe (south to Bay of Biscay). It is fun loving but mercurial, and can be nasty to those it doesn't consider friends.",
    attributes: {
      fun: 8,
      honor: -7,
      intelligence: 5,
  ...
  },
  {
    ...
    description:
      "The blue mussel (Mytilus edulis), also known as the common mussel, is a medium-sized edible marine bivalve mollusc in the family Mytilidae, the mussels. Blue mussels are known to be honorable, intelligent, and decisive.",
    attributes: {
      fun: -4,
      honor: 8,
      intelligence: 8,
  ...
  },
  {
    ...
    description:
      "The warty venus, Venus verrucosa, is a species of saltwater clam. It is a species of marine bivalve mollusc in the family Veneridae, sometimes collectively known as the venus clams. Among the most fun loving of clams, the warty venus also known for its toughness and disdain for maintaining appearances.",
    attributes: {
      fun: 14,
      honor: -1,
      intelligence: 5,
  ...
  },
  {
    ...
    description:
      "Pecten maximus, also known as the great scallop, king scallop, St James shell or escallop, is a northeast Atlantic species of scallop, an edible saltwater clam, a marine bivalve mollusc in the family Pectinidae. It is known to be a natural leader with a strict code of honor, and clams who do battle by its side tend to emerge victorious.",
    attributes: {
      fun: -4,
      honor: 14,
      intelligence: -7,
  ...
  },
  {
    ...
    description:
      "The maxima clam (Tridacna maxima), also known as the small giant clam, is a species of bivalve mollusc found throughout the Indo-Pacific region. It is known for its striking coloration and its unstoppable energy-- a maxima clam is always pushing its limits in pursuit of fun and glory.",
    attributes: {
      fun: 17,
      honor: -4,
      intelligence: -4,
  ...
  },
  {
    ...
    description:
      "Pinctada radiata, commonly known as the Atlantic pearl-oyster or the Gulf pearl oyster is a species of pearl oyster distributed throughout the Indo-Pacific. It is obsessed with physical beauty in all of its forms but particularly loves glitter and seaquins.",
    attributes: {
      fun: 11,
      honor: 2,
      intelligence: 2,
  ...
  },
  {
    ...
    description:
      "Pinna nobilis, common name the noble pen shell or fan mussel, is a large species of Mediterranean clam, a marine bivalve mollusc in the family Pinnidae, the pen shells. The noble pen shell is pure hearted and an excellent warrior, but can come across as stuffy or self righteous to less high minded clams.",
    attributes: {
      fun: -10,
      honor: 17,
      intelligence: 11,
